...
robocopy $sourceFolder "$destinationFolder/$projectName" /MIR /IF *.aspx *.dll *.js ipsv.xml *.css csc.* csi.* /XD aspnet_client obj Properties App_GlobalResources App_Start
...
CreateVirtualDirectory $websiteName "atoz" "$destinationFolder\$projectName" true "$projectName-$websiteName"
DisableAnonymousAuthentication $websiteName "atoz"
EnableWindowsAuthentication $websiteName "atoz"
